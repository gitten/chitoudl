...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "UpdateName": return {ctor: "_Tuple2",_0: _U.update(model,{userName: _p0._0}),_1: $Effects.none};
         case "SelectGender": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var Next = {ctor: "Next"};
   var nextButton = function (address) {    return A2($Html.button,_U.list([A2($Html$Events.onClick,address,Next)]),_U.list([$Html.text("Next")]));};
   var SelectGender = {ctor: "SelectGender"};
   var UpdateName = function (a) {    return {ctor: "UpdateName",_0: a};};
   var viewName = F2(function (address,model) {
      return A2($Html.input,
      _U.list([A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p1) {    return A2($Signal.message,address,UpdateName(_p1));})]),
      _U.list([]));
   });
   var view = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([A2(viewName,address,model),nextButton(address)]));});
   var Model = F2(function (a,b) {    return {userName: a,gender: b};});
   var init = function () {    var model = {userName: "",gender: _U.list([])};return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}();
